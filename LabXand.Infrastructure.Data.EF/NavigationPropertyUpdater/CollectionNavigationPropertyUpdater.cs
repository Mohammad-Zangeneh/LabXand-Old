...
{
    internal class CollectionNavigationPropertyUpdater<TRoot, T, I> : PropertyUpdaterBase<TRoot>
        where TRoot : class
        where T : class, IDomainEntity<I>
    {
        public CollectionNavigationPropertyUpdater(IPropertyUpdaterCustomizer<TRoot> propertyUpdaterCustomizer, UpdateCollectionConfiguration<TRoot, T, I> updateConfig)
        ...
        public override void Update(DbContextBase context, TRoot rootCurrentValue, TRoot rootOriginalValue)
        {
