...
{
    internal class ManyToManyUpdater<TRoot, T, I> : PropertyUpdaterBase<TRoot>
        where TRoot : class
        where T : class, IDomainEntity<I>
    {
        public ManyToManyUpdater(IPropertyUpdaterCustomizer<TRoot> propertyUpdaterCustomizer, UpdateManyToManyCollection<TRoot, T, I> updateConfig)
