...
{
    internal class OneNavigationPropertyUpdater<TRoot, T, I> : PropertyUpdaterBase<TRoot>
        where TRoot : class
        where T : class, IDomainEntity<I>
    {
        public OneNavigationPropertyUpdater(IPropertyUpdaterCustomizer<TRoot> propertyUpdaterCustomizer, UpdateOneEntityConfiguration<TRoot, T, I> updateConfig)
