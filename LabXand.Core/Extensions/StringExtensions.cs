...
namespace LabXand.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string ApplyHtmlSanitize(this object data)
        {
            return data == null ? null : ApplyHtmlSanitize(data.ToString());
        }
        public static string ApplyHtmlSanitize(this string data)
        {
            return string.IsNullOrWhiteSpace(data) ?
                        string.Empty :
                        new HtmlSanitizer().Sanitize(data);
        }
        #endregion
    }
